...
pub mod pkp_helper {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("getPubkeyRouterAddress"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
                                "getPubkeyRouterAddress",
                            ),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
    ...
    impl<M: ::ethers::providers::Middleware> PKPHelper<M> {
        ...
        ///Calls the contract's `getPubkeyRouterAddress` (0xc53fe4c7) function
        pub fn get_pubkey_router_address(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
            M,
            ::ethers::core::types::Address,
    ...
    ///Container type for all input parameters for the `getPubkeyRouterAddress` function with signature `getPubkeyRouterAddress()` and selector `0xc53fe4c7`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "getPubkeyRouterAddress", abi = "getPubkeyRouterAddress()")]
    pub struct GetPubkeyRouterAddressCall;
    ...
    pub enum PKPHelperCalls {
        ...
        GetPubkeyRouterAddress(GetPubkeyRouterAddressCall),
    ...
    impl ::ethers::core::abi::AbiDecode for PKPHelperCalls {
        fn decode(
            ...
            if let Ok(decoded) = <GetPubkeyRouterAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetPubkeyRouterAddress(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for PKPHelperCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::GetPubkeyRouterAddress(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<GetPubkeyRouterAddressCall> for PKPHelperCalls {
        fn from(value: GetPubkeyRouterAddressCall) -> Self {
            Self::GetPubkeyRouterAddress(value)
        }
    }
    ...
    ///Container type for all return fields from the `getPubkeyRouterAddress` function with signature `getPubkeyRouterAddress()` and selector `0xc53fe4c7`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct GetPubkeyRouterAddressReturn(pub ::ethers::core::types::Address);
