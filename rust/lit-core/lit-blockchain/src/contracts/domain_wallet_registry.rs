...
pub mod domain_wallet_registry {
    ...
    impl<M: ::ethers::providers::Middleware> DomainWalletRegistry<M> {
        ...
        ///Calls the contract's `registerDomainAndMintNext` (0x3909d2ff) function
    ...
    ///Container type for all input parameters for the `registerDomainAndMintNext` function with signature `registerDomainAndMintNext(bytes,string,bytes,uint256,uint256[],bytes[],bytes[],uint256[][],string[])` and selector `0x3909d2ff`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "registerDomainAndMintNext(bytes,string,bytes,uint256,uint256[],bytes[],bytes[],uint256[][],string[])"
    )]
    ...
    ///Container type for all return fields from the `registerDomainAndMintNext` function with signature `registerDomainAndMintNext(bytes,string,bytes,uint256,uint256[],bytes[],bytes[],uint256[][],string[])` and selector `0x3909d2ff`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
