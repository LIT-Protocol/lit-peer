...
pub mod host_commands {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("ExpirationTimeInPast"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
                                "ExpirationTimeInPast",
                            ),
                            inputs: ::std::vec![],
                        },
                    ],
    ...
    ///Custom Error type `ExpirationTimeInPast` with signature `ExpirationTimeInPast()` and selector `0x0dbe4bff`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "ExpirationTimeInPast", abi = "ExpirationTimeInPast()")]
    pub struct ExpirationTimeInPast;
    ...
    pub enum HostCommandsErrors {
        ...
        ExpirationTimeInPast(ExpirationTimeInPast),
    ...
    impl ::ethers::core::abi::AbiDecode for HostCommandsErrors {
        fn decode(
            ...
            if let Ok(decoded) = <ExpirationTimeInPast as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ExpirationTimeInPast(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for HostCommandsErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::ExpirationTimeInPast(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for HostCommandsErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <ExpirationTimeInPast as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ if selector
    ...
    impl ::core::convert::From<ExpirationTimeInPast> for HostCommandsErrors {
        fn from(value: ExpirationTimeInPast) -> Self {
            Self::ExpirationTimeInPast(value)
        }
    }
    ...
    impl ::ethers::contract::EthLogDecode for HostCommandsEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(HostCommandsEvents::OwnershipTransferredFilter(decoded));
            }
    ...
    impl ::core::convert::From<OwnershipTransferredFilter> for HostCommandsEvents {
    ...
    impl ::core::convert::From<OwnerCall> for HostCommandsCalls {
    ...
    impl ::core::convert::From<TransferOwnershipCall> for HostCommandsCalls {
