//! This file copies the basic event formatting logic from here: https://github.com/tokio-rs/tracing/blob/acf92ab944f6fa0c9dee0302a334d4fdf0cfe52a/tracing-subscriber/src/fmt/format/mod.rs
//!
