...
#[cfg(feature = "service")]
const LOGGING_SERVICE_GRPC_SOCK_PATH: &str = "/var/run/lit-logging-service-grpc.sock";
#[cfg(feature = "service")]
pub const ENV_LOGGING_SERVICE_GRPC_SOCK_PATH: &str = "LIT_LOGGING_SERVICE_GRPC_SOCK_PATH";
#[cfg(feature = "service")]
...
pub trait LitLoggingConfig {
    ...
    #[cfg(feature = "service")]
    fn logging_service_grpc_socket_path(&self) -> PathBuf;
}
...
impl LitLoggingConfig for LitConfig {
    ...
    #[cfg(feature = "service")]
    fn logging_service_grpc_socket_path(&self) -> PathBuf {
        logging_service_grpc_socket_path()
    }
}
...
#[cfg(feature = "service")]
pub fn logging_service_grpc_socket_path() -> PathBuf {
    if let Ok(path) = env::var(ENV_LOGGING_SERVICE_GRPC_SOCK_PATH) {
        return PathBuf::from(path);
    }

    PathBuf::from(LOGGING_SERVICE_GRPC_SOCK_PATH)
}
