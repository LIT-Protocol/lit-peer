...
pub mod payment_delegation {
    ...
    impl<M: ::ethers::providers::Middleware> PaymentDelegation<M> {
        ...
        ///Calls the contract's `setRestriction` (0xd6c57540) function
        pub fn set_restriction(
            &self,
            r: Restriction,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([214, 197, 117, 64], (r,))
                .expect("method not found (this should never happen)")
        }
    ...
    #[ethevent(
        name = "RestrictionSet",
        abi = "RestrictionSet(address,(uint128,uint256,uint256))"
    )]
    ...
    ///Container type for all input parameters for the `setRestriction` function with signature `setRestriction((uint128,uint256,uint256))` and selector `0xd6c57540`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "setRestriction",
        abi = "setRestriction((uint128,uint256,uint256))"
    )]
    ...
    ///`Restriction(uint128,uint256,uint256)`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
