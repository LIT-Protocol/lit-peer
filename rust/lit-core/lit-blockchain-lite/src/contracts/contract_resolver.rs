...
pub mod contract_resolver {
    ...
    #[allow(deprecated)]
        ...
        [
                ...
                (
                    ::std::borrow::ToOwned::to_owned("PUB_KEY_ROUTER_VIEWS_CONTRACT"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            name: ::std::borrow::ToOwned::to_owned(
                                "PUB_KEY_ROUTER_VIEWS_CONTRACT",
                            ),
                            inputs: ::std::vec![],
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
    ...
    impl<M: ::ethers::providers::Middleware> ContractResolver<M> {
        ...
        ///Calls the contract's `PUB_KEY_ROUTER_VIEWS_CONTRACT` (0x81d49578) function
        pub fn pub_key_router_views_contract(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, [u8; 32]> {
            self.0
                .method_hash([129, 212, 149, 120], ())
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `PUB_KEY_ROUTER_VIEWS_CONTRACT` function with signature `PUB_KEY_ROUTER_VIEWS_CONTRACT()` and selector `0x81d49578`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        ...
        abi = "PUB_KEY_ROUTER_VIEWS_CONTRACT()"
    )]
    pub struct PubKeyRouterViewsContractCall;
    ...
    pub enum ContractResolverCalls {
        ...
        PubKeyRouterViewsContract(PubKeyRouterViewsContractCall),
    ...
    impl ::ethers::core::abi::AbiDecode for ContractResolverCalls {
        fn decode(
            ...
            if let Ok(decoded) = <PubKeyRouterViewsContractCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PubKeyRouterViewsContract(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for ContractResolverCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::PubKeyRouterViewsContract(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<PubKeyRouterViewsContractCall> for ContractResolverCalls {
        fn from(value: PubKeyRouterViewsContractCall) -> Self {
            Self::PubKeyRouterViewsContract(value)
        }
    }
    ...
    ///Container type for all return fields from the `PUB_KEY_ROUTER_VIEWS_CONTRACT` function with signature `PUB_KEY_ROUTER_VIEWS_CONTRACT()` and selector `0x81d49578`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    pub struct PubKeyRouterViewsContractReturn(pub [u8; 32]);
