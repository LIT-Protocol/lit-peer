#[cfg(feature = "server")]
use crate::context::{HEADER_KEY_X_CORRELATION_ID, HeaderInjector, TRACING};
use crate::error::{EC, Result, connect_err_code, http_client_err, timeout_err_code};
...
use {
    ...
    opentelemetry_sdk::propagation::TraceContextPropagator, std::collections::HashMap,
