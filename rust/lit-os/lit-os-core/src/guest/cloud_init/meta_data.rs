use crate::error::{Result, io_err, serializer_err, validation_err};
...
mod tests {
    ...
    fn verify_invalid_test() {
        for (test, exp_err, guest_type, env, instance_id, guest_kind) in [
            (
                "meta-data-invalid2", "hostname is not a valid for lit-os guests", None, None,
                None, None,
            ),
            (
                "meta-data-invalid3", "hostname is not a valid for lit-os guests", None, None,
                None, None,
            ),
            (
                "meta-data-ok",
                "hostname 'prov-dev-0563e3e8.litos-guest.litnet.io' does not contain provided instance id 'abcd'",
                Some(&GuestType::Prov),
                Some(&LitEnv::Dev),
                Some("abcd"),
                None,
            ...
            (
                "meta-data-ok",
                "hostname 'prov-dev-0563e3e8.litos-guest.litnet.io' does not contain provided env 'prod'",
                Some(&GuestType::Prov),
                Some(&LitEnv::Prod),
                Some("0563e3e8"),
                None,
            ...
            (
                "meta-data-ok",
                "hostname 'prov-dev-0563e3e8.litos-guest.litnet.io' does not contain provided guest_type 'node'",
                Some(&GuestType::Node),
                Some(&LitEnv::Dev),
                Some("0563e3e8"),
                None,
            ...
            (
                "meta-data-ok3",
                "hostname is not a valid for lit-os guests (does not match)",
                Some(&GuestType::Node),
                Some(&LitEnv::Dev),
                Some("0563e3e8"),
                None,
            ...
            let cloud_init =
                CloudInitMetaData::try_from(file_path.as_path()).expect("failed to load");
