...
pub const CLOUD_INIT_FILE_RPC_CONFIG_OVERLAY: &str = "rpc-config.overlay.yaml";

pub const ALLOWED_CLOUD_INIT_FILES: [&str; 8] = [
    CLOUD_INIT_FILE_META_DATA, CLOUD_INIT_FILE_NETWORK_CONFIG, CLOUD_INIT_FILE_USER_DATA,
    CLOUD_INIT_FILE_INIT_PW, CLOUD_INIT_FILE_SAFE_BOOT, CLOUD_INIT_FILE_NO_RESIZE,
    CLOUD_INIT_FILE_LIT_CONFIG, CLOUD_INIT_FILE_RPC_CONFIG_OVERLAY,
];
