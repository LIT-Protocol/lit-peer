...
use crate::error::{Result, conversion_err, io_err};
use std::path::Path;
#[allow(unused_imports)]
...
mod tests {
    ...
    fn sys_sha512sum_test() {
        ...
        assert_eq!(
            out,
            "925f43c3cfb956bbe3c6aa8023ba7ad5cfa21d104186fffc69e768e55940d9653b1cd36fba614fba2e1844f4436da20f83750c6ec1db356da154691bdd71a9b1"
        );
    }
}
