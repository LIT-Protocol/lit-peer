...
use crate::{
    data::cache::{CACHE, CacheValue},
    error::{self, Result, generic_err_code, io_err_code, validation_err_code},
};
...
pub(crate) async fn handle_req(req: Request) -> Result<Response> {
    ...
    trace!(req = ?req, "attestation::handle_req");
...
mod tests {
    ...
    use crate::data::cache::cache_key_session;
    use crate::handler::attestation::{ENV_ATTESTATION_SERVICE_BYPASS_GENERATE, handle_req};
