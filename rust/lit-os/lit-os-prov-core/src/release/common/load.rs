...
use crate::error::{EC, Result, blockchain_err_code, validation_err, validation_err_code};
use crate::release::common::manifest::{ReleaseManifest, load_release_manifest};
...
pub async fn load_release_assets(
    ...
    trace!(
        ...
        manifest_cid = release.manifest_cid(),
