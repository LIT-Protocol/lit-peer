...
use lit_os_core::guest::env::build::{GuestBuildEnv, load_guest_build_env};
use lit_os_core::guest::env::release::{GuestReleaseEnv, load_guest_release_env};
use lit_os_core::guest::types::{GuestCpuType, GuestType};
use lit_os_core::utils::sev_snp::sev_snp_measure_cmp;

use crate::error::{
    Result, attestation_err, conversion_err, io_err, ipfs_err, parser_err, unexpected_err,
    validation_err,
};
...
mod tests {
    ...
    use crate::release::common::manifest::{GuestType, parse_release_manifest};
    ...
    fn parse_release_manifest_test() {
        ...
        assert_eq!(
            manifest.meta().build_uname,
            "Linux ioflood-sev01 5.19.0-rc6-snp-host-d9bd54fea4d2 #1 SMP Fri Oct 14 16:30:36 EDT 2022 x86_64 GNU/Linux"
        );
