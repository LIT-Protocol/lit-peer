...
use crate::cmd::os::guest::template::create::{
    GuestTemplateCreate, handle_cmd_os_guest_template_create,
};
use crate::cmd::os::guest::template::delete::{
    GuestTemplateDelete, handle_cmd_os_guest_template_delete,
};
use crate::cmd::os::guest::template::describe::{
    GuestTemplateDescribe, handle_cmd_os_guest_template_describe,
};
use crate::cmd::os::guest::template::ls::handle_cmd_os_guest_template_ls;
use crate::cmd::os::guest::template::release::{
    GuestTemplateRelease, handle_cmd_os_guest_template_release,
};
