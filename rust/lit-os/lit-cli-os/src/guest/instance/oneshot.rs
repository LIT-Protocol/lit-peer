...
use crate::cmd::os::guest::template::release::{GuestTemplateRelease, do_release_template};
#[cfg(feature = "guest-build")]
...
use lit_os_core::guest::oneshot::config::{
    ACTION_SETTINGS_KEY_GUEST_VCPUS, ACTION_SETTINGS_KEY_REQUEST, ACTION_TYPE_BOOTSTRAP,
    ActionEntry, OneShotConfig,
};
        ...
        GuestType::Prov => {
            ...
            if prov_args.bootstrap {
                ...
                let args = GuestTemplateRelease {
                    ...
                    // No network_name means GitHub publishing will be skipped.
                    // Bootstrap doesn't need public GitHub releases.
                    network_name: None,
