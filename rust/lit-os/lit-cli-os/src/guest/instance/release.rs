...
use lit_os_prov_core::release::common::manifest::{
    ASSET_KEY_AMD_OVMF, ASSET_KEY_BUILD_ENV, ASSET_KEY_BUILD_META, ASSET_KEY_GUEST_DISK,
    ASSET_KEY_GUEST_INITRD, ASSET_KEY_GUEST_KERNEL, ASSET_KEY_GUEST_KERNEL_CMDLINE,
    ASSET_KEY_RELEASE_ENV, ReleaseManifest,
};
