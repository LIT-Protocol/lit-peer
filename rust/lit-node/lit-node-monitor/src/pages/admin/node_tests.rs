...
pub fn Realms() -> impl IntoView {
    ...
    view! {
        ...
        <div class="card" >
            <div class="card-body">
                <h5 class="card-title">New Realms</h5>
...
fn setup_shadow_splicing(ctx: &WebCallBackContext) {
    ...
    leptos::task::spawn_local(async move {
        ...
        // let new_stakers = staking.get_unassigned_staker_addresses().call().await;
        // log::info!("New Stakers: {:?}", new_stakers);
        // let new_stakers = new_stakers.unwrap();
        // let new_stakers = new_stakers.into_iter().take(2).collect();
