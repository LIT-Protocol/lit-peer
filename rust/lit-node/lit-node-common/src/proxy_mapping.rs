...
pub struct ClientProxyMapping {
    proxy_mappings: BTreeMap<Url, BTreeMap<Url, Url>>,
}

#[allow(dead_code)]
impl Default for ClientProxyMapping {
    fn default() -> Self {
        Self::new()
    }
}

impl ClientProxyMapping {
    pub fn new() -> Self {
        Self {
...
impl TryFrom<&Path> for ClientProxyMapping {
...
impl TryFrom<Vec<u8>> for ClientProxyMapping {
    type Error = crate::error::Error;
...
impl TryFrom<&[u8]> for ClientProxyMapping {
    type Error = crate::error::Error;
