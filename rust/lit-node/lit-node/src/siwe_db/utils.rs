use crate::error::{EC, Result, parser_err, validation_err_code};
...
mod siwe_timestamp_validity_tests {
    ...
    use crate::siwe_db::utils::{
        MAX_TIMESTAMP_VALIDITY_DAYS, check_block_timestamp_validity, check_expiration_validity,
        make_timestamp_siwe_compatible,
    };
