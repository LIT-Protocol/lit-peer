use crate::error::{EC, Result, blockchain_err_code, validation_err_code};
...
use lit_node_core::{JsonAuthSig, constants::AUTH_SIG_DERIVED_VIA_CONTRACT_SIG_SHA256};
...
pub async fn validate_eip1271_signature(
    ...
    let hashed_message = if auth_sig.derived_via == AUTH_SIG_DERIVED_VIA_CONTRACT_SIG_SHA256 {
        ...
        ethers::utils::hash_message(&auth_sig.signed_message).0
    };
