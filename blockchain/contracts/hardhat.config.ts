...
import '@lit-protocol/hardhat-diamond-abi';
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    yellowstone: {
      ...
      wlitAddress: '0x5E8db2E7af793f4095c4843C8cBD87C5D8604838',
      trustedForwarderAddress: '0x63F15BC77EA4C0b4361a879F6D16D7a5C635DB6C',
    },
    litMainnet: {
      url: 'https://lit-chain-rpc.litprotocol.com',
      ...(process.env['LIT_ROLLUP_MAINNET_DEPLOYER_PRIVATE_KEY'] && {
        accounts: [process.env['LIT_ROLLUP_MAINNET_DEPLOYER_PRIVATE_KEY']],
      }),
      chainId: 175200,
  ...
  etherscan: {
    apiKey: {
      ...
      litMainnet: 'woof', // Blockscout does not require an API key but needs the string to be populated
    ...
    customChains: [
      ...
      },
      {
        ...
        urls: {
          ...
          browserURL: 'https://lit-chain-explorer.litprotocol.com/',
        },
      },
    ],
  },
