      ...
      const tx = await pkpHelper.mintNextAndAddAuthMethodsWithTypes(
        {
          ...
          permittedIpfsCIDs: ipfsIdsBytes,
          permittedIpfsCIDScopes: [[], []],
          permittedAddresses: addressesToPermit,
          permittedAddressesScopes: [[], []],
          permittedAuthMethodTypes: authMethodTypes,
          permittedAuthMethodIds: authMethodUserIds,
          permittedAuthMethodPubkeys: authMethodPubkeys,
          permittedAuthMethodScopes: [[], []],
          addPkpEthAddressAsPermittedAddress: true, //addPkpEthAddressAsPermittedAddress,
          sendPkpToItself: false, // sendPkpToItself
        },
        transaction
      );
      ...
      const tx = await pkpHelper.mintNextAndAddAuthMethodsWithTypes(
        {
          ...
          permittedAuthMethodScopes: [[], []],
          addPkpEthAddressAsPermittedAddress: true, //addPkpEthAddressAsPermittedAddress,
          sendPkpToItself: true, // sendPkpToItself
        },
        transaction
      );
      expect(tx).to.emit(pkpContract, 'PKPMinted');
      ...
      const tx = await pkpHelper.mintNextAndAddAuthMethodsWithTypes(
        {
          ...
          permittedAuthMethodScopes: [],
          addPkpEthAddressAsPermittedAddress: false, //addPkpEthAddressAsPermittedAddress,
          sendPkpToItself: false, //sendPkpToItself
        },
        transaction
      );
