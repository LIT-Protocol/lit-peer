// Full command: HARDHAT_NETWORK=<NETWORK> npx ts-node --files scripts/diamondContracts/removeFacet.ts --git-sha <GIT_SHA> --contract-name <CONTRACT_NAME> --diamond-owner-signer-private-key <PRIVATE_KEY> --diamond-contract-address <DIAMOND_CONTRACT_ADDRESS>
