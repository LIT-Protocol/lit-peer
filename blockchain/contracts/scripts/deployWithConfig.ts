...
import {
  fundAdministratorWallet,
  fundAndStakeNodes,
} from './fundAndStakeNodes';
...
async function deployWithConfig() {
  ...
  // deployFullConfig.deployNodeConfig!.newOwnerAddress =
  //   '0x38b08ef8de2b9d9d83bd0e00b1c269366d93df38';

  // deployFullConfig.deployNodeConfig!.newDomainWalletAdminAddress =
  //   '0x38b08ef8de2b9d9d83bd0e00b1c269366d93df38';
  ...
  switch (deploymentSelection) {
    case DeploymentSelection.LIT_CORE:
      result = await _deployLitCoreContracts(deployCoreConfig);
      break;
    case DeploymentSelection.LIT_NODE:
      result = await _deployLitNodeContracts(
        deployNodeConfig!,
        deploySensitiveConfig
      );
      break;
    case DeploymentSelection.LIT_CORE_AND_LIT_NODE:
      result = await _deployLitCoreAndNodeContracts(
        deployCoreConfig,
        deployNodeConfig!,
        deploySensitiveConfig
      );
...
async function _deployLitCoreAndNodeContracts(
  ...
  // await fundAdministratorWallet('0x38b08ef8de2b9d9d83bd0e00b1c269366d93df38', deployNodeConfig);
